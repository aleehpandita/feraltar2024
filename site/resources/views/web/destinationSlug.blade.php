...
@section('content')
  <!-- /header -->
      ...
      <div class="swiper-container swiper-thumbs-container swiper-fullscreen nav-dark" data-margin="0" data-autoplay="true" data-autoplaytime="7000" data-nav="true" data-dots="false" data-items="1" data-thumbs="true">
        <div class="swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="{{ asset('assets/img/photos/bg28.jpg') }}"></div>
            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="{{ asset('assets/img/photos/bg29.jpg') }}"></div>
            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="{{ asset('assets/img/photos/bg30.jpg') }}"></div>
            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="{{ asset('assets/img/photos/bg31.jpg') }}"></div>
          </div>
          <!--/.swiper-wrapper -->
        </div>
        <!-- /.swiper -->
        <div class="swiper swiper-thumbs">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="{{ asset('assets/img/photos/bg28-th.jpg') }}" srcset="{{ asset('assets/img/photos/bg28-th@2x.jpg') }} 2x" alt="" /></div>
            <div class="swiper-slide"><img src="{{ asset('assets/img/photos/bg29-th.jpg') }}" srcset="{{ asset('assets/img/photos/bg29-th@2x.jpg') }} 2x" alt="" /></div>
            <div class="swiper-slide"><img src="{{ asset('assets/img/photos/bg30-th.jpg') }}" srcset="{{ asset('assets/img/photos/bg30-th@2x.jpg') }} 2x" alt="" /></div>
            <div class="swiper-slide"><img src="{{ asset('assets/img/photos/bg31-th.jpg') }}" srcset="{{ asset('assets/img/photos/bg31-th@2x.jpg') }} 2x" alt="" /></div>
          </div>
          <!--/.swiper-wrapper -->
        </div>
        <!-- /.swiper -->
      ...
      <div class="container py-14 py-md-16">
        ...
        <div class="row grid-view gx-md-8 gx-xl-10 gy-8 gy-lg-0 text-center">
          <div class="col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div class="card shadow-lg">
              <figure class="card-img-top overlay overlay-1">
                <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fs1.jpg')}}" srcset="{{ asset('assets/img/photos/fs1@2x.jpg') }} 2x" alt="" /></a>
                <figcaption>
          ...
          <div class="col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div class="card shadow-lg">
              <figure class="card-img-top overlay overlay-1">
                <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fs2.jpg')}}" srcset="{{ asset('assets/img/photos/fs2@2x.jpg') }} 2x" alt="" /></a>
                <figcaption>
                  <h5 class="from-top mb-0">View Gallery</h5>
                </figcaption>
              </figure>
          ...
          <div class="col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div class="card shadow-lg">
              <figure class="card-img-top overlay overlay-1">
                <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fs3.jpg') }}" srcset="{{ asset('assets/img/photos/fs3@2x.jpg') }} 2x" alt="" /></a>
                <figcaption>
                  <h5 class="from-top mb-0">View Gallery</h5>
                </figcaption>
              </figure>
    ...
    <!-- /section -->
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="{{ asset('assets/img/photos/bg32.jpg') }}">
            ...
            <div class="swiper overflow-visible pb-2">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc1.jpg') }}" srcset="{{ asset('assets/img/photos/fc1@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc2.jpg') }}" srcset="{{ asset('assets/img/photos/fc2@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc3.jpg') }}" srcset="{{ asset('assets/img/photos/fc3@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc4.jpg') }}" srcset="{{ asset('assets/img/photos/fc4@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc5.jpg') }}" srcset="{{ asset('assets/img/photos/fc5@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc6.jpg') }}" srcset="{{ asset('assets/img/photos/fc6@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="card shadow-lg">
                    <figure class="card-img-top overlay overlay-1">
                      <a href="#"><img class="img-fluid" src="{{ asset('assets/img/photos/fc7.jpg') }}" srcset="{{ asset('assets/img/photos/fc7@2x.jpg') }} 2x" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0">View Gallery</h5>
                      </figcaption>
                    </figure>
    ...
    <!-- /section -->
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="{{ asset('assets/img/photos/bg33.jpg') }}">
      <div class="container py-14 py-md-17 text-center">
        <div class="row">
      ...
      <div class="container pt-12 pt-md-14 pb-14 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-6 align-items-center">
          <div class="col-md-8 col-lg-6 mx-auto">
            <div class="img-mask mask-1"><img src="{{ asset('assets/img/photos/about29.jpg') }}" srcset="{{ asset('assets/img/photos/about29@2x.jpg') }} 2x" alt="" /></div>
          </div>
          <!--/column -->
          <div class="col-lg-6">
            ...
            <div class="swiper overflow-visible pb-2">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b12.jpg') }}" srcset="{{ asset('assets/img/photos/b12@2x.jpg')}} 2x" alt="" /></a>
                        <figcaption>
                ...
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b13.jpg') }}" srcset="{{ asset('assets/img/photos/b13@2x.jpg')}} 2x" alt="" /></a>
                        <figcaption>
                          <h5 class="from-top mb-0">Read More</h5>
                        </figcaption>
                      </figure>
                ...
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b14.jpg') }}" srcset="{{ asset('assets/img/photos/b14@2x.jpg') }} 2x" alt="" /></a>
                        <figcaption>
                          <h5 class="from-top mb-0">Read More</h5>
                        </figcaption>
                      </figure>
                ...
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b15.jpg') }}" srcset="{{ asset('assets/img/photos/b15@2x.jpg') }} 2x" alt="" /></a>
                        <figcaption>
                          <h5 class="from-top mb-0">Read More</h5>
                        </figcaption>
                      </figure>
                ...
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b16.jpg') }}" srcset="{{ asset('assets/img/photos/b16@2x.jpg') }} 2x" alt="" /></a>
                        <figcaption>
                          <h5 class="from-top mb-0">Read More</h5>
                        </figcaption>
                      </figure>
                ...
                <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1"><a href="#"> <img src="{{ asset('assets/img/photos/b17.jpg') }}" srcset="{{ asset('assets/img/photos/b17@2x.jpg') }} 2x" alt="" /></a>
                        <figcaption>
                          <h5 class="from-top mb-0">Read More</h5>
                        </figcaption>
                      </figure>
